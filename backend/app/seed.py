...
def seed_data(db: Session) -> None:
    ...
    db.query(FarmerDemo).delete()
    db.query(ExpenseEntry).delete()
    db.query(TravelEntry).delete()
    db.query(Indent).delete()
    db.query(Scheme).delete()
    db.query(BusinessProduct).delete()
    db.query(LedgerEntry).delete()
    db.query(Customer).delete()
    db.query(User).filter(User.system_type == "business").delete()
